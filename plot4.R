...
## Define layout for plot 4
par(mfrow = c(2,2))

##Create line chart for Plot 4
plot(power_feb$date_time , power_feb$global_active_power_kw, type = "n" , xlab = "", ylab = "Global Active Power (kilowatts)")
lines(power_feb$date_time , power_feb$global_active_power_kw)

##Create voltage line chart for Plot 4
plot(power_feb$date_time , power_feb$voltage, type = "n" , xlab = "datetime", ylab = "Voltage")
lines(power_feb$date_time , power_feb$voltage)

##Create 3 line plot for Plot 4
...
##Create voltage line chart for Plot 4
plot(power_feb$date_time , power_feb$global_reactive_power_kw, type = "n" , xlab = "datetime", ylab = "Global_reactive_power")
